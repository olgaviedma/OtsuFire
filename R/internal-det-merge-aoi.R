...
#' @param strip_ecoregion Logical. If TRUE, drops ecoregion-related columns
#'   from outputs based on `ecoregion_field` and `drop_pattern`.
#' @param ecoregion_field Character or NULL. Explicit ecoregion column name
#'   to drop, in addition to `drop_pattern` matches.
#' @param drop_pattern Character. Case-insensitive regex applied to column
