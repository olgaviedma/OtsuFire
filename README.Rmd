...
Automated tools to map fire scars using Landsat-based RBR/dNBR composites using Otsu thresholding. It supports large-area mosaics, polygonization, filtering, regeneration assessment, and validation workflows.
...
```{r Import data from ZENODO, echo=TRUE, message=FALSE, warning=FALSE}
...
output_dir <- "C:/OtsuFire/inst/exdata"         # Final directory for extracted files
