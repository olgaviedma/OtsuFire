...
#' single fixed selection rule (\code{"strict_hotspot"}). The resulting
#' samples are intended to feed
...
#'   \code{year == target_year} are excluded (to avoid leaking the year
#'   being scored into its own reference).
